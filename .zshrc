...
export PATH=$HOME/bin:/usr/local/bin:/home/volt/.local/bin:$PATH
...
alias kali="sudo docker start 303 -i"
alias vi="nvim"
alias py="python3"
...
__conda_setup="$('/home/volt/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/volt/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/volt/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/volt/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
